...
export default function Filters() {
  const { search: searchText, status: filterStatus, priorities: filterPriorities } = useTodoStore(
  ...
  const togglePriorityFilter = useTodoStore((state) => state.togglePriorityFilter);
