...
export default function TodoList() {
  ...
  // Filter todos locally to avoid full API refetch on keypress
  ...
  const handleAdd = () => {
    if (!todoName.trim() || addMutation.isPending) return;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputCard}>
        <TextInput
          ...
          placeholder={addMutation.isPending ? "Adding task..." : "What needs to be done?"}
        ...
        <View style={styles.optionsRow}>
          <View style={styles.prioritySelector}>
            {priorityOptions.map((opt) => {
              ...
              return (
                <Pressable
                  key={opt}
                  onPress={() => !addMutation.isPending && setPriority(opt)}
                  style={[
                    styles.priorityBtn,
                    {
          ...
          <Pressable
            onPress={handleAdd}
            disabled={!todoName.trim() || addMutation.isPending}
            style={({ pressed }) => [
              styles.addButton,
              (!todoName.trim() || addMutation.isPending) && styles.addButtonDisabled,
              pressed && !addMutation.isPending && styles.addButtonPressed,
            ]}
          >
