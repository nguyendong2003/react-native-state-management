...
2.  Mở file `android/app/src/debug/java/com/reactnativecli0632v2/ReactNativeFlipper.java` (đường dẫn package tùy thuộc tên project của bạn) và thay thế toàn bộ nội dung file thành một class stub trống để không gọi thư viện Flipper:

    ```java
    package com.reactnativecli0632v2;
